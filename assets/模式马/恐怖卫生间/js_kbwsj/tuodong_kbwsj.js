cc.Class({
    ...
    touchDown(even) {
        if(this.id==10&&this.fu.getComponent("guiyiweishengjian").jieduan1==false){
            return;
        }
        if(this.id==20&&this.fu.getComponent("guiyiweishengjian").jieduan2==false){
            return;
        }
        this.xz = true;
        this.node.zIndex=0;
    ...
    touchEnd(even) {
        ...
        if(this.xz){
            if(this.wu){
                if(this.id==10){
                    this.fu.getComponent("guiyiweishengjian").muban();
                }else if(this.id==20){
                    this.fu.getComponent("guiyiweishengjian").qiaosuo();
                }
